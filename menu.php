...
<nav class="navbar navbar-expand-sm bg-light navbar-light d-none d-sm-block">
  <ul class="navbar-nav">
    ...
    <li id="2" class="nav-item">
      <a class="nav-link" href="himek.php">Hímek</a>
    </li>
    <li id="3" class="nav-item">
      <a class="nav-link" href="nostenyek.php">Nőstények</a>
    </li>
    <li id="4" class="nav-item">
      <a class="nav-link" href="kolykok.php">Kölykök</a>
    </li>
...
<nav class="navbar navbar-inverse bg-light navbar-light d-block d-sm-none">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li id="11" class="nav-item">
          <a class="nav-link" href="index.php">Főoldal</a>
        </li>
        <li id="22" class="nav-item">
          <a class="nav-link" href="himek.php">Hímek</a>
        </li>
        <li id="33" class="nav-item">
          <a class="nav-link" href="nostenyek.php">Nőstények</a>
        </li>
        <li id="44" class="nav-item">
          <a class="nav-link" href="kolykok.php">Kölykök</a>
        </li>
